...
(function (factory) {
    ...
    function Filtrolista(el, options) {
        var noop = function () { },
            that = this,
            defaults = {
                ...
                deferRequestBy: 0,
                params: {},
                formatResult: Filtrolista.formatResult,
                delimiter: null,
                zIndex: 9999,
                type: 'GET',
                noCache: false,
    ...
    Filtrolista.utils = utils;

    $.Filtrolista = Filtrolista;

    Filtrolista.formatResult = function (suggestion, currentValue) {
    ...
    Filtrolista.prototype = {
        ...
        initialize: function () {
            ...
            that.suggestionsContainer = Filtrolista.utils.createNode('<div class="' + options.containerClass + '" style="position: absolute; display: none;"></div>');
    ...
    $.fn.filtrolista = function (options, args) {
        return this.each(function () {
            ...
            if (typeof options === 'string') {
                ...
                instance = new Filtrolista(this, options);
