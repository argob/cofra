...
class ProgramaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MagypRendicionDeCajaBundle:Programa')->findAll();
     ...
     *
     * @Route("/{id}/show", name="programa_show")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MagypRendicionDeCajaBundle:Programa')->find($id);
    ...
    {
        $entity = new Programa();
        $form   = $this->createForm(new ProgramaType(), $entity);
     ...
     *
     * @Route("/create", name="programa_create")
     * @Method("POST")
     * @Template("MagypRendicionDeCajaBundle:Programa:new.html.twig")
     */
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new ProgramaType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
     ...
     *
     * @Route("/{id}/update", name="programa_update")
     * @Method("POST")
     * @Template("MagypRendicionDeCajaBundle:Programa:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}/delete", name="programa_delete")
     * @Method("POST")
     */
