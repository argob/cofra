...
class AreaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MagypRendicionDeCajaBundle:Area')->findAll();
     ...
     *
     * @Route("/{id}/show", name="entidades_area_show")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MagypRendicionDeCajaBundle:Area')->find($id);
     ...
     *
     * @Route("/new", name="entidades_area_new")
     * @Template()
     */
     ...
     *
     * @Route("/create", name="entidades_area_create")
     * @Method("POST")
     * @Template("MagypRendicionDeCajaBundle:Area:new.html.twig")
     */
     ...
     *
     * @Route("/{id}/edit", name="entidades_area_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/update", name="entidades_area_update")
     * @Method("POST")
     * @Template("MagypRendicionDeCajaBundle:Area:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}/delete", name="entidades_area_delete")
     * @Method("POST")
     */
